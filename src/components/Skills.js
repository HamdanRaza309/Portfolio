                    ...
                    >
                        ...
                        >
                            {category.skills.map((skill) => (
                                <div
                                    key={skill.name}
                                    className="flex flex-col items-center justify-center gap-2 sm:gap-3 bg-transparent border-2 border-gray-700 rounded-3xl py-1.5 px-3 sm:py-2 sm:px-4 text-center"
                                >
                                    <img
                                        src={skill.logo}
                                        alt={`${skill.name} logo`}
