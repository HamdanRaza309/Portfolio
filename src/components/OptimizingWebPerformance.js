...
const OptimizingWebPerformance = () => {
    return (
        <div className="container mx-auto px-4 py-8 bg-white text-black">
            <header className="mb-8 text-center">
                <h1 className="text-5xl font-bold text-black mb-2">Optimizing Web Performance</h1>
            ...
            <section className="mb-12">
                <h2 className="text-3xl font-semibold text-black mb-4">Step 1: Code Splitting</h2>
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Dynamic Imports</h3>
                    <p className="text-lg mb-2">
                        Use dynamic imports to load JavaScript modules only when they are needed:
                    </p>
                    <pre className="bg-gray-200 p-4 rounded-lg overflow-x-auto text-green-500">
    ...
    // Use MyComponent
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">React Lazy and Suspense</h3>
                    <p className="text-lg mb-2">
...
function App() {
    return (
        <React.Suspense fallback={<div>Loading...</div>}>
            ...
            <section className="mb-12">
                <h2 className="text-3xl font-semibold text-black mb-4">Step 2: Lazy Loading</h2>
                <p className="text-lg mb-4 leading-relaxed">
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Lazy Loading Images</h3>
                    <p className="text-lg mb-2">
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Lazy Loading Components</h3>
                    <p className="text-lg mb-2">
...
function App() {
    return (
        <React.Suspense fallback={<div>Loading...</div>}>
            ...
            <section className="mb-12">
                <h2 className="text-3xl font-semibold text-black mb-4">Step 3: Minimizing HTTP Requests</h2>
                <p className="text-lg mb-4 leading-relaxed">
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Combine Files</h3>
                    <p className="text-lg mb-2">
                        Where possible, combine multiple CSS or JavaScript files into a single file:
                    </p>
                </div>
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Use CSS Sprites</h3>
                    <p className="text-lg mb-2">
...
.icon-2 {
    background-position: -50px 0;
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Reduce Third-Party Requests</h3>
                    <p className="text-lg mb-2">
            ...
            <section className="mb-12">
                <h2 className="text-3xl font-semibold text-black mb-4">Step 4: Optimize Images</h2>
                <p className="text-lg mb-4 leading-relaxed">
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Image Compression</h3>
                    <p className="text-lg mb-2">
                        Use tools to compress your images without sacrificing quality:
                    </p>
                </div>
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Responsive Images</h3>
                    <p className="text-lg mb-2">
                        Use the <code className='text-green-500'>&lt;picture&gt;</code> element or <code className='text-green-500'>srcset</code> attribute:
                    </p>
                    <pre className="bg-gray-200 p-4 rounded-lg overflow-x-auto text-green-500">
                        {`<picture>
    ...
    <img src="image-small.jpg" alt="Example">
                ...
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Use WebP Format</h3>
                    <p className="text-lg mb-2">
            ...
            <section className="mb-12">
                <h2 className="text-3xl font-semibold text-black mb-4">Step 5: Leverage Browser Caching</h2>
                <p className="text-lg mb-4 leading-relaxed">
                    Browser caching allows you to store certain resources locally in the user's browser, which can improve load times for subsequent visits.
                </p>
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Set Cache-Control Headers</h3>
                    <p className="text-lg mb-2">
                        Configure your server to set appropriate cache headers:
                    </p>
                </div>
                <div className="bg-gray-100 border-l-4 border-red-500 p-4 rounded-lg shadow-lg mt-4">
                    <h3 className="text-2xl font-semibold text-red-600 mb-2">Use a CDN</h3>
                    <p className="text-lg mb-2">
                        Content Delivery Networks (CDNs) can cache your content and serve it from locations closer to your users:
                    </p>
                </div>
            </section>
            ...
            <section className="mb-12">
                ...
                <p className="text-lg leading-relaxed">
                    Implementing these performance optimization techniques can significantly enhance the speed and responsiveness of your web application. By focusing on code splitting, lazy loading, minimizing HTTP requests, optimizing images, and leveraging browser caching, you can provide a better user experience and improve overall performance.
                </p>
            </section>
        </div>
    );
